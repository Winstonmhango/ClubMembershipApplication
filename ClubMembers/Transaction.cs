...
namespace ClubMembers
{
    public class Transaction
    {
        ...
        public Transaction()
        {
            ...
            //ClubMember cm = new ClubMember(username);
        ...
        public string Save()
        {
            ...
            Debug.WriteLine("[" + this.semester + "]");
            Debug.WriteLine("[" + this.username + "]");
            Debug.WriteLine("[" + this.transDate + "]");
            Debug.WriteLine("[" + this.depositNumber + "]");
            Debug.WriteLine("[" + this.checkNumber + "]");
            Debug.WriteLine("[" + this.description + "]");
            Debug.WriteLine("[" + this.amount + "]");
            Debug.WriteLine("[" + this.transNo + "]");
